...
class ModeloUsuarios{
    ...
    static public function mdlRegistroUsuario($tabla, $datos){
        ...
        $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, clave, email, foto, modo, verificacion, email_encriptado) VALUES (:nombre, :clave, :email, :foto, :modo, :verificacion, :email_encriptado)");
